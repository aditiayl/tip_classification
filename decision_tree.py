...
for filename in os.listdir(test_folder_path):
    if filename.endswith(".png"):
        ...
        # Predict the category of the test image using Decision Tree
        predicted_category = label_encoder.inverse_transform(dt_model.predict(test_img_scaled))[0]
        
        # Display the result
        print(f'The predicted category for {filename} using Decision Tree is: {predicted_category}')
