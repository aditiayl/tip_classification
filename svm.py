...
# Step 6: Training SVM
svm_model = SVC(kernel='linear', C=1)  # You can adjust the kernel and C parameter based on your dataset
...
test_folder_path = 'test/'  # Replace with the path to your test images folder
...
for filename in os.listdir(test_folder_path):
    if filename.endswith(".png"):
        ...
        predicted_category = label_encoder.inverse_transform(svm_model.predict(test_img_scaled))[0]
