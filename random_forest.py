...
# Step 4: Flatten and scale features
...
rf_model = RandomForestClassifier(n_estimators=100, random_state=42)  # You can adjust the number of estimators based on your dataset
...
# Step 9: Test the Model on a New Images in a Folder
...
for filename in os.listdir(test_folder_path):
    if filename.endswith(".png"):
        ...
        predicted_category = label_encoder.inverse_transform(rf_model.predict(test_img_scaled))[0]
